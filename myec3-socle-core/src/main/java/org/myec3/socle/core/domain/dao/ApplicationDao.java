 ...
 * {@link Application} objects). It only defines new specific methods and
 * inherits methods from {@link ResourceDao}.
 * 
 * @author Baptiste Meurant <baptiste.meurant@atosorigin.com>
 * @author Denis Cucchietti <denis.cucchietti@atosorigin.com>
 */
public interface ApplicationDao extends ResourceDao<Application> {
	 ...
	 *         no result. Return an empty list if no result.
	 * 
	...
	List<Application> findAllApplicationByStructureType(
			StructureType structureType);
	 ...
	 *             in case of errors
	 */
	List<Application> findAllByCriteria
			(String label, StructureType structureType);
