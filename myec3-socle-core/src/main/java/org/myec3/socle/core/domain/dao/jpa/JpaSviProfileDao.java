 ...
 */
@Repository("sviProfileDao")
public class JpaSviProfileDao extends JpaNoResourceGenericDao<SviProfile> implements SviProfileDao {

	@Override
	public Class<SviProfile> getType() {
		return SviProfile.class;
	}
}
