...
/**
 * This class allows to override marshal and unmarshal methods for attributes of
 * type Timestamp in order to choose the format of the Timestamp to send into
 * the XML.
 * 
 * To Use this adapter you must add the annotation :
 * 
 * @XmlJavaTypeAdapter(TimestampAdapter.class) over the attribute to send into
 *                                             the XML
 * 
