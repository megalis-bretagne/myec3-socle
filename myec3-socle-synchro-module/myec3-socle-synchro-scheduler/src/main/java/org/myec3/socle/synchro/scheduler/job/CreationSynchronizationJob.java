...
/**
 * Concrete job implementation for creation synchronization tasks
 * 
 * @author Baptiste Meurant <baptiste.meurant@atosorigin.com>
 * 
 */
@Component
public class CreationSynchronizationJob extends GenericSynchronizationJob {
	...
	protected void executeInternal(JobExecutionContext arg0)
		...
		this.getSynchronizationManager().synchronizeCreation(
