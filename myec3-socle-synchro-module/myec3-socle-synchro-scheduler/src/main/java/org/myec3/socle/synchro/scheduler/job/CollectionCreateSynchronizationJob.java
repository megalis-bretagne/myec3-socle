...
/**
 * Concrete job implementation used when a synchronized collection is created
 * 
 * @author Matthieu Proboeuf <matthieu.proboeuf@atosorigin.com>
 * 
 */
@Component
public class CollectionCreateSynchronizationJob extends
	...
	protected void executeInternal(JobExecutionContext arg0)
		...
		this.getSynchronizationManager().synchronizeCollectionCreate(
				this.getResource(), this.getRelationName(),
				this.getCreatedResources(), this.getSendingApplication());
	}
