...
import org.myec3.socle.synchro.controller.TestSycnhroSDMController;
import org.springframework.context.annotation.*;
import org.springframework.web.servlet.config.annotation.EnableWebMvc;

@Configuration
@Import({HealthCheckConfig.class, AsyncConfiguration.class, JcmsInitAgentsController.class, JcmsInitService.class, TestSycnhroSDMController.class})
@EnableWebMvc
