 ...
 * {@link SynchronizationLog} specific operations. This interface extends the
 * common {@link GenericService} interface by adding new specific methods
 * 
 * @author Denis Cucchietti <denis.cucchietti@atosorigin.com>
 */
public interface SynchronizationLogService extends IGenericService<SynchronizationLog> {
	 ...
	 * 
	 */
	List<SynchronizationLog> findAllSynchronizationLogByResourceId(Long resourceId);

	/**
	 * Find all {@link SynchronizationLog} associated directly to an
	 * synchronizationLog.
	 * 
	 * @param synchronizationLogId : the ID of a synchronizationLog
	 * 
	 * @return List of {@link SynchronizationLog} associated to this synchronization
	 *         log. return an empty list if no result or null in case of error.
	 * 
	 */
	 ...
	 * 
	 * @param startDate           : the begin date of synchronization
	 * @param endDate             : the end date of synchronization
	 * @param application         : the application (@see Application) synchronized
	 * @param resourceType        : the type of the resource synchronized (@see
	 *                            ResourceType)
	 ...
	 *                            finished or not
	 * 
	 * @return a list of {@link SynchronizationLog} corresponding at given criteria.
