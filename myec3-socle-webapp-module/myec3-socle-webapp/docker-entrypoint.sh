...
export JAVA_OPTS="$JAVA_OPTS ${PROXY_JAVA_OPTS} -Duser.timezone=Europe/Paris -Dglowroot.agent.id=megalis::webapp::${NODE_HOSTNAME} -javaagent:/glowroot/glowroot.jar"
